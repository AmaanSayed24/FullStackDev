...
function mainMenu() {
  console.log('\n📘 Reminder CLI');
  console.log('1️⃣  Add Reminder');
  console.log('2️⃣  View Reminders');
  console.log('3️⃣  Edit Reminder');
  console.log('4️⃣  Start All Reminders');
  console.log('5️⃣  Start Specific Reminder');
  console.log('6️⃣  Exit');

  ask('➡️ Choose (1-6): ', choice => {
    switch (choice.trim()) {
...
function addFlow() {
  ask('\n📝 Task name: ', task => {
    if (!task.trim()) return console.log('⚠️ Empty name.') || mainMenu();
    ask('⏱️ Delay in seconds: ', delayStr => {
